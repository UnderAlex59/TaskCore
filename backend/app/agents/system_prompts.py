...
QA_ANSWER_SYSTEM_PROMPT = (
    ...
    "Если используешь контекст сторонней задачи, явно назови эту задачу в answer "
    "и перечисли использованные chunk_id в used_cross_task_chunk_ids. "
    "Если сторонние задачи не использовались, верни пустой массив used_cross_task_chunk_ids. "
...
QA_VERIFIER_SYSTEM_PROMPT = (
    ...
    "Если final_answer опирается на стороннюю задачу, явно назови эту задачу в final_answer "
    "и перечисли использованные chunk_id в used_cross_task_chunk_ids. "
    "Если сторонние задачи не использовались, верни пустой массив used_cross_task_chunk_ids. "
