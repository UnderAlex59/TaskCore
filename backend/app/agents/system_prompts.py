...
VALIDATION_CORE_SYSTEM_PROMPT = (
    ...
    "Текст задачи может содержать GitHub Flavored Markdown таблицы; считай каждую строку и ячейку таблицы смысловой частью требования, а не декоративной разметкой. "
