...
from app.core.validation_settings import DEFAULT_VALIDATION_NODE_SETTINGS
...
class Project(Base):
    ...
    validation_node_settings: Mapped[dict[str, bool]] = mapped_column(
        JSONB,
        nullable=False,
        default=lambda: dict(DEFAULT_VALIDATION_NODE_SETTINGS),
        server_default=text(
