...
const EVENT_TYPE_LABELS: Record<string, string> = {
  ...
  "admin.llm_prompt.restored": "Восстановлена версия промпта агента",
  "admin.llm_prompt.updated": "Обновлен промпт агента",
  "admin.llm_vision.tested": "Выполнен Vision-тест",
  "admin.llm_monitoring.updated": "Обновлены настройки LLM-мониторинга",
...
const ENTITY_TYPE_LABELS: Record<string, string> = {
  ...
  llm_prompt: "промпт агента",
  llm_provider: "LLM-провайдер",
  llm_runtime_settings: "настройки LLM-мониторинга",
  llm_vision_test: "vision-тест",
  message: "сообщение",
  project: "проект",
